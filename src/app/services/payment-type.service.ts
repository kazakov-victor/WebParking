...
export class PaymentTypeService {
  private paymentTypeUrl = '/paymenttype';
  httpOptions = {
  ...
  getPaymentTypes(): Observable<PaymentType[]> {
    return this.http.get<PaymentType[]>(`${environment.BackUrl}${this.paymentTypeUrl}/list`)
      .pipe(
  ...
  getPaymentTypeNo404<Data>(id: number): Observable<PaymentType> {
    const url = `${environment.BackUrl}${this.paymentTypeUrl}/?id=${id}`;
  ...
  getPaymentType(id: number): Observable<PaymentType> {
    const url = `${environment.BackUrl}${this.paymentTypeUrl}/edit/${id}`;
  ...
  savePaymentType(paymentType: PaymentType): Observable<PaymentType> {
    ...
    return this.http.post<PaymentType>(`${environment.BackUrl}${this.paymentTypeUrl}/save`, paymentType, this.httpOptions).pipe(
  ...
  deletePaymentType(paymentType: PaymentType | number): Observable<PaymentType> {
    ...
    const url = `${environment.BackUrl}${this.paymentTypeUrl}/delete/${id}`;
